...
8. **CẤM ĐỌC CUỐN CHIẾU TOÀN BỘ FILE LỚN:** Tuyệt đối không gọi liên tiếp nhiều lần `view_file` để đọc hết 500-1000 dòng file. Phải grep trúng vị trí cần sửa và chỉ đọc 20-50 dòng liên quan.
