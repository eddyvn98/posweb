...
export default function Layout() {
    ...
    const mainItems = [
        { path: '/app/sales', label: 'Bán hàng', icon: '🛒' },
        { path: '/app/modules', label: 'Module', icon: '💎' },
        { path: '/app/reports', label: 'Báo cáo', icon: '📊' },
    ]

    const sidebarItems = [
        { path: '/app/dashboard', label: 'Tổng quan', icon: '⛺' },
        { path: '/app/sales', label: 'Bán hàng', icon: '🛒' },
        { path: '/app/products', label: 'Sản phẩm', icon: '📦' },
        { path: '/app/imports', label: 'Nhập hàng', icon: '📥' },
        { path: '/app/imports-sheet', label: 'Nhập sheet', icon: '🧾' },
        { path: '/app/reports', label: 'Thống kê', icon: '📊' },
        { path: '/app/cashbook', label: 'Sổ quỹ', icon: '📈' },
        { path: '/app/history', label: 'Lịch sử', icon: '📜' },
        { path: '/app/modules', label: 'Cửa hàng Module', icon: '💎' },
        { path: '/app/settings', label: 'Cài đặt', icon: '⚙️' },
    ]
        ...
        <div className="min-h-screen bg-pink-50/30 flex flex-col md:flex-row">
            ...
            <aside className="hidden md:flex w-64 bg-white border-r border-pink-100 flex-col sticky top-0 h-screen z-20">
                ...
                <div className="p-4 border-t border-pink-50">
                    ...
                    {pendingCount > 0 && (
                        <div className="text-xs text-orange-500 font-bold mb-2 px-2">
            ...
            {/* Main Content Area — use Outlet for nested routing */}
                ...
                <div className="md:hidden fixed inset-0 z-40">
                    ...
                    <div className="absolute bottom-24 left-0 right-0 mx-2 bg-white rounded-3xl shadow-2xl overflow-hidden z-50">
                        ...
                        <div className="p-4 border-t border-pink-100 space-y-4">
                            <div>
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    <a 
                                        ...
                                        target="_blank" 
                                        rel="noopener noreferrer"
                                        className="flex items-center justify-center gap-2 p-3 rounded-2xl bg-blue-50 text-blue-600 font-bold"
                                    >
                                    ...
                                    <a 
                                        ...
                                        target="_blank" 
                                        rel="noopener noreferrer"
                                        className="flex items-center justify-center gap-2 p-3 rounded-2xl bg-sky-50 text-sky-600 font-bold"
                                    >
                            ...
                            <div className="flex items-center justify-between px-2 pt-2 border-t border-pink-50">
